...
import { setCookie } from "https://deno.land/std@0.148.0/http/mod.ts";
import type { Cookie } from "https://deno.land/std@0.148.0/http/mod.ts";
...
export const handler: Handlers<any, any> = {
  async POST(req, _ctx) {
    ...
    let redirect = "/";
    if (!token) {
      redirect = "/signup?error=token_error";
    }
